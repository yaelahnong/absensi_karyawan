...
<html lang="en">
    ...
    <body>
        ...
        <?php 
            if(isset($_POST['ubah_hak_akses'])) {
                if(ubah_hak_akses($_POST) > 0) {
                    echo "<script>Swal.fire({
                        title: 'Success!',
                        text: 'Change data is successful',
                        icon: 'success',
                        confirmButtonText: 'OK'
                    }).then(() => {window.location.href='employee-level.php';} )</script>";
                } else {
                    echo "<script>Swal.fire({
                        title: 'Error!',
                        text: 'Change error data',
                        icon: 'error',
                        confirmButtonText: 'OK'
                                        ...
                                        <div class="container-fluid">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-6 text-right mb-2 pb-1">
                                                    <a class="btn btn-primary text-light" href="user-description-add.php?id=<?= $id_akses ?>">[+] Add User Description</a>
                                                </div>
                                            </div>
                                        </div>
                ...
                swal.fire({
                    ...
                    if(result.isConfirmed) {
                        swal.fire({
                            ...
                            if(result.isConfirmed) {
                                window.location.href=`user-description-delete.php?id=${id_hak_akses}`;
                            }
                        })
