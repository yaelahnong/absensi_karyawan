<?php   
    ...
    @$employee_menu = query("SELECT hak_akses.deskripsi FROM akses, hak_akses WHERE akses.id_akses = $id_akses_admin AND deskripsi = 'employee' AND akses.id_akses = hak_akses.id_akses")[0];
    ...
    <div id="remove-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <?php if($employee_menu): ?>
                <li>
                <a href="javascript:void(0);" class="waves-effect"><i class="icon-paper-sheet"></i><span> Employee <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                    <ul class="submenu">
